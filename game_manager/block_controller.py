...
class Block_Controller(object):
    ...
    def counthole(self,board,xpos,ypos):
        ...
        for yy in range(height-1,ypos+4-1,-1):
            #if (yy < height):
            if board[(yy) * width + (xpos)] == 0:
                hole += 1
            else:
    ...
    def calcEvaluationValueIndex2(self,board,nextindex):
        ...
        dic_dir2 = {0x71:8,0x41:8,0x51:8,0x61:8,0x70:8,0x30:2,0x20:2,\
    ...
    def calcEvaluationValueIndex3(self,board,nextindex):
        ...
        dic_dir0 = {0x11:7}
        dic_dir1 = {0x111:8}
        dic_dir2 = {0x17:8,0x14:8,0x15:8,0x16:8,0x07:8,0x03:2,0x02:2,\
